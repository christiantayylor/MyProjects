...
class PartTest {
    ...
    @Test
    void getSetMinInventory() {
        partIn.setMinInv(0);
        assertEquals(0, partIn.getMinInv(), "Min inventory set and retrieved correctly for InhousePart.");

        partOut.setMinInv(0);
        assertEquals(0, partOut.getMinInv(), "Min inventory set and retrieved correctly for OutsourcedPart.");
    }

    @Test
    void getSetMaxInventory() {
        partIn.setMaxInv(500);
        assertEquals(500, partIn.getMaxInv(), "Max inventory set and retrieved correctly for InhousePart.");

        partOut.setMaxInv(500);
        assertEquals(500, partOut.getMaxInv(), "Max inventory set and retrieved correctly for OutsourcedPart.");
    }
